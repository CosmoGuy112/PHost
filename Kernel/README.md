...
## ประเภทของ Kernel อื่นๆ
-  ### Exo Kernel ###
    Exo Kernel เป็นประเภทของเคอร์เนลที่ยึดหลักการทำงานแบบ End-to-End โดยมีหลักการสำคัญดังนี้
...
-  ### Nano Kernel ###
     Nano Kernel เป็นประเภทของเคอร์เนลที่ให้การแยกฮาร์ดแวร์ เป็นประเภทของเคอร์เนลที่มีขนาดเล็ก แต่ไม่มีบริการระบบ ในขณะที่ไมโครเคอร์เนลก็ไม่มีบริการระบบเช่นกัน ดังนั้น  Nano Kernel และ Micro Kernel จึงกลายเป็นสิ่งที่คล้ายคลึงกัน 
