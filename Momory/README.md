...
จะแสดงข้อมูลเกี่ยวกับการใช้หน่วยความจำในระบบจากไฟ `/proc/meminfo`
เป็นเครื่องมือที่ใช้ในการตรวจสอบสถานะของระบบและการทำงานของกระบวนการ (processes) ในเวลาที่เป็นเรียลไทม์ มีอินเทอร์เฟซที่เข้าใจง่ายและให้ข้อมูลเพิ่มเติมเกี่ยวกับหน่วยความจำ CPU usage และ process list
...........................
